...
n=[2,11,13,11,13,5];
d=[94.12e-3,133.99e-3,30.4e-3,18.81e-3];
d=-d;
...
%% Plots
figure()
plot(lambda,Rp(:,1).*100)
hold on
plot(lambda,Rp(:,2).*100)
legend('0 degree','30 degree')
xlabel('Wavelength \lambda (\mum)')
ylabel('Reflectivity (%)')
title('P Polarized Reflectivity')

figure()
plot(lambda,Rs(:,1).*100)
hold on
plot(lambda,Rs(:,2).*100)
legend('0 degree','30 degree')
xlabel('Wavelength \lambda (\mum)')
ylabel('Reflectivity (%)')
title('S Polarized Reflectivity')
...
xlabel('Wavelength \lambda (\mum)')
ylabel('Reflectivity (%)')
title(' Unpolarized Reflectivity')
